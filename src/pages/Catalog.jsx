      ...
      return (
        <>
          ...
          <div className=" mx-auto box-content w-full max-w-maxContentTab px-4 py-12 lg:max-w-maxContent">
            ...
            <div>
              <CourseSlider
                Courses={active ===1 ? catalogPageData?.data?.selectedCategory?.courses :  catalogPageData?.data?.selectedCategory?.courses}
              />
            </div>
          </div>
          {/* Section 2 */}
          ...
          {/* Section 3 */}
          <div className="text-richblack-5 mx-auto box-content w-full max-w-maxContentTab px-4 py-12 lg:max-w-maxContent">
